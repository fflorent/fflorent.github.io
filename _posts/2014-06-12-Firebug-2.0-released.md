...
Il y a aussi de nombreux traducteurs de Firebug qui traduisent dans 35 langues&nbsp;!
...
<li>Utilisation de la nouvelle bibliothèque de déboguage</li>
...
## Nouvelle bibliothèque de déboguage

Pour proposer le déboguage de script et l'évaluation d'expression depuis sa Console,
Firebug repose sur la bibliothèque de déboguage appelée [Javascript Debugger API](https://developer.mozilla.org/en-US/docs/Tools/Debugger-API).
...
Mais c'est aussi grâce à l'utilisation de cette bibliothèque de déboguage que de nouvelles
